...
| セクション | 対応ファイル | 対応箇所 |
|---|---|---|
| メタ定義 | `model/06_views.md` | 「View 4: 依存関係ビュー」セクション |
| 依存の4つの型 | `model/04d_dependency_map.md` | 「依存の型」セクション |
| 記述項目 | `model/04d_dependency_map.md` | 「記述項目」セクション |
| ボトルネック移動 | `model/04e_dynamics.md` | ボトルネック移動の分析 |
