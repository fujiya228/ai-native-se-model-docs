...
| セクション | 対応ファイル | 対応箇所 |
|---|---|---|
| 4パターンの定義 | `model/04e_dynamics.md` | 「3.2 ボトルネック移動パターン」セクション |
| 全体像の図 | `model/04e_dynamics.md` | 「3.3 ボトルネック移動の全体像」セクション |
| フロー分析の手順 | `model/04e_dynamics.md` | 「4. フロー分析の適用手順」セクション |
| 失敗パターンとの接続 | `model/04e_dynamics.md` | 「5.5 失敗パターンとの接続」セクション |
