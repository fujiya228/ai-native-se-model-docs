...
description: "Implementation（L1）の4つのL2ステップについて、AIエージェント前提での実行設計・制御環境・As-Is/To-Be比較を具体的に記述した適用例。"
sidebar:
  order: 2
---
...
| 項目 | 値 |
|---|---|
| **対象** | Implementation（L1）— 文脈収集 / 変更実装 / テスト作成・更新 / ローカル整合確認 の4つのL2 |
...
| セクション | 対応ファイル | 対応箇所 |
|---|---|---|
| 実行設計ビュー As-Is/To-Be | `model/instances/implementation_transformation.md` | セクション1 |
| 制御環境ビュー | `model/instances/implementation_transformation.md` | セクション2 |
| As-Is/To-Be 比較 | `model/instances/implementation_transformation.md` | セクション3 |
| 依存関係 | `model/instances/implementation_transformation.md` | セクション4 |
| Validation | `model/instances/implementation_transformation.md` | セクション6 |
