...
description: "Verification & Review（L1）の4つのL2ステップについて、Implementation高速化によるボトルネック移動を受けた実行設計・制御環境・対処設計を記述した適用例。"
sidebar:
  order: 3
---
...
| 項目 | 値 |
|---|---|
| **対象** | Verification & Review（L1）— 自動検証 / 人レビュー / 差し戻し判断 / 修正反映確認 の4つのL2 |
...
| L2 | 何が変わるか | なぜ変えるか |
|---|---|---|
| 自動検証 | CIの結果判定にAIが加わり、失敗分析と自動修正を試行する | CI失敗→人間が分析→修正依頼のループが遅い |
...
Implementation の高速化によるボトルネック移動に、3つのレベルで対処する。
...
| セクション | 対応ファイル | 対応箇所 |
|---|---|---|
| 実行設計ビュー As-Is/To-Be | `model/instances/verification_review_transformation.md` | セクション1 |
| 制御環境ビュー | `model/instances/verification_review_transformation.md` | セクション2 |
| As-Is/To-Be 比較 | `model/instances/verification_review_transformation.md` | セクション3 |
| ボトルネック移動への対処 | `model/instances/verification_review_transformation.md` | セクション3.3 |
| 依存関係 | `model/instances/verification_review_transformation.md` | セクション4 |
| Validation | `model/instances/verification_review_transformation.md` | セクション6 |
| Implementation との接続 | `model/instances/verification_review_transformation.md` | セクション7 |
