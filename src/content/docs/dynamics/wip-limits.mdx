...
| セクション | 対応ファイル | 対応箇所 |
|---|---|---|
| WIP制限の有効性 | `model/04e_dynamics.md` | 「7.1 なぜWIP制限が有効か」セクション |
| AI文脈での具体例 | `model/04e_dynamics.md` | 「7.2 AI文脈でのWIP制限の具体例」セクション |
| 裁量レベルとの関係 | `model/04e_dynamics.md` | 「7.3 WIP制限と裁量レベルの関係」セクション |
