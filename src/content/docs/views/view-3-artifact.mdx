...
さらに、[基底モデルで述べたとおり](/foundation/base-model/#指示セッション文脈も媒介物である)、AI への指示文やセッション文脈そのものも、ステップ間を流れる媒介物である。このビューで受け渡しを記述する際は、文書やコードに加えて「AI に実際に何が指示されたか」も受け渡しの対象に含めるかを検討する。
